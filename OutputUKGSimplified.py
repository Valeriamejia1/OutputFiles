...
pdf_folder = r"C:\Python tools\PDF reader\OutputFiles\QA\UKG - Simplified"
output_folder = r"C:\Python tools\PDF reader\OutputFiles\OUTPUT UKGSimplified"

pdf_files = [
    "Qualvis TimeSheets 2023-06-03.pdf",
    "TimeDetailsSorted_KEVCOL.pdf",
...
for pdf_file in pdf_files:
    ...
    formato_pos = (302, 272)  # Reemplaza con las coordenadas reales
    pyautogui.click(formato_pos)
