...
pdf_folder = r"C:\Python tools\PDF reader\OutputFiles\QA\UKG - Kronos"
output_folder = r"C:\Python tools\PDF reader\OutputFiles\OUTPUT UKG  Kronos"

pdf_files = [
    "Qualivis Time report PPE 062423.pdf",
...
for pdf_file in pdf_files:
    ...
    # Selecciona el formato en "Select Report Type" y "UKG kronos"
    formato_pos = (320, 162)  # Reemplaza con las coordenadas reales
    pyautogui.click(formato_pos)
    time.sleep(1)

    formato_pos = (324, 282)  # Reemplaza con las coordenadas reales
    pyautogui.click(formato_pos)
