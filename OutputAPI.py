...
pdf_files = [
    "Dawson, Kathleen.pdf",
    "Delta Health 4.15.23.pdf",
    "Hannibal 4.15.23.pdf",
    "Mattox, Kyle.pdf",
    "TMMC W.E. 4.22.pdf",
...
for pdf_file in pdf_files:
    ...
    # Haz click en el botón "NO Sched" y selecciona el archivo PDF
...
for pdf_file in pdf_files:
    ...
    # Seleccionar "OK"
    formato_pos = (110, 607)  # Reemplaza con las coordenadas reales
    pyautogui.click(formato_pos)
