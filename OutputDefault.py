...
pdf_files = [
    "06-11.pdf",
    "1690203601050_1994364726.pdf",
    "1690808400472_1671940182.pdf",
    "Combined File.pdf",
    "Kronos Timecards TC 07-30-22.pdf",
    "Scripps Approved Kronos we 6.25.22.pdf",
    "Time Detail_100822-102122.pdf",
    "Time Detail_July152022.pdf",
    "time weston.pdf",
...
for pdf_file in pdf_files:
    ...
    # Haz click en el botón "NO minutes" y selecciona el archivo PDF
    formato_pos = (1042, 620)  # Reemplaza con las coordenadas reales
    pyautogui.click(formato_pos)
